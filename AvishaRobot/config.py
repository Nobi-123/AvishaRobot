...
class Config(object):
    ...
    OWNER_ID = getenv("OWNER_ID", "7694170809") 

    OWNER_USERNAME = ("OWNER_USERNAME", "Og_Zerathos")
    
    SUPPORT_CHAT = getenv("SUPPORT_CHAT", "Satisfxn")
   
    START_IMG = getenv("START_IMG", "https://files.catbox.moe/gzkykj.jpg")

    JOIN_LOGGER = getenv("JOIN_LOGGER", "-1002681848382")
   
    EVENT_LOGS = getenv("EVENT_LOGS",  "-1002681848382")
  
    ERROR_LOGS = getenv("ERROR_LOGS", "-1002681848382")

    MONGO_DB_URI= getenv("MONGO_DB_URI", None)
   
    LOG_CHANNEL = getenv("LOG_CHANNEL", "-1003065367480")
   
    BOT_USERNAME = getenv("BOT_USERNAME" , "VegitoEditGurdian_Bot")
